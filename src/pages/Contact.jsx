...
export default function Contact() {
  ...
  return (
    <div className="pt-20">
      {/* Hero */}
      <section className="flex flex-col items-center gap-6 px-8 md:px-20 py-16 md:py-20">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-center">Get In Touch</h1>
