  ...
  return (
    <div className="pt-20">
      ...
      <section className="flex flex-col items-center gap-8 px-8 md:px-20 py-20 md:py-[100px]">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-center">About ACELLIQ</h1>
        ...
        <div className="rounded-2xl h-[300px] md:h-[400px] w-full max-w-[900px] bg-bg-card border border-border-subtle" />
      </section>

      {/* Mission Vision Values */}
      <section className="flex flex-col items-center gap-12 px-8 md:px-20 py-20">
        <div className="flex flex-col items-center gap-4">
          <span className="text-accent-lime text-xs font-semibold tracking-[3px]">OUR FOUNDATION</span>
          <h2 className="text-4xl md:text-5xl font-bold text-center">Mission, Vision & Values</h2>
        </div>
      ...
      <section className="bg-gradient-to-b from-bg-dark to-bg-deeper px-8 md:px-20 py-20 flex flex-col items-center gap-12">
        <div className="flex flex-col items-center gap-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-center">Meet the Minds Behind ACELLIQ</h2>
      ...
      <section className="flex flex-col items-center gap-12 px-8 md:px-20 py-20">
        <div className="flex flex-col items-center gap-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-center">From Vision to Global Impact</h2>
        </div>
        <div className="flex items-center gap-0 w-full justify-center">
          {milestones.map((ms, i) => (
            <div key={ms.year} className="flex items-center">
              ...
              {i < milestones.length - 1 && <div className="h-0.5 w-12 md:w-20 bg-border-subtle mx-6 md:mx-10" />}
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-bg-card">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row px-8 md:px-20 py-15">
          {stats.map((s, i) => (
            <div key={s.label} className={`flex-1 flex flex-col items-center gap-2 py-8 md:py-0 ${i > 0 && i < stats.length ? 'md:border-l border-border-subtle' : ''}`}>
